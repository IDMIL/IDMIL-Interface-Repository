...
![T-Stick Sopranino schematics](../MEDIA-FILES/GUIDE-IMAGES/Images/Sopranino2GW_schematics.png)
...
**TIP**: Before start assembling the T-Stick, pay attention to the position of the components. Plan yourself to place the components for them to not "overlap" each other (check image below). Also, make sure the cables are long enough to allow the tube and caps to be opened and closed properly.


![building_Sopranino 2nd image](../MEDIA-FILES/GUIDE-IMAGES/Images/building_Sopranino_2.jpg)
...
**WARNING**: THE CAPSENSE BOARD HAS THE CONNECTORS LABELED FOR THE MICROCONTROLLER (IN) AND IMU (OUT). BE CAREFUL WHEN CONNECTING THEM BECAUSE OF A LAST MINUTE CHANGE IN THE PINOUT OF THE BOARD. SEE SCHEMATIC BELOW. 
...
![Capsense-IMU connection](../MEDIA-FILES/GUIDE-IMAGES/Images/IMU_connection.jpg "Capsense-IMU connection")
...
![T-Stick Sopranino IMU parts](../MEDIA-FILES/GUIDE-IMAGES/Images/SopraninoIMUparts.jpg)
The T-Stick Spatial orientation is dened as follows:

![T-Stick Sopranino orientation](../MEDIA-FILES/GUIDE-IMAGES/Images/T-Stick-Orientation.png)
...
![T-Stick Sopranino - piezo placement](../MEDIA-FILES/GUIDE-IMAGES/Images/piezo_in_place_h.jpg)
...
![T-Stick Sopranino - Envelope Follower Circuit](../MEDIA-FILES/GUIDE-IMAGES/Images/envelope_follower.png)

##### Voltage Divider Circuit

![T-Stick Sopranino - Voltage Divider Circuit](../MEDIA-FILES/GUIDE-IMAGES/Images/voltage_divider.png)
...
![Overview](../MEDIA-FILES/GUIDE-IMAGES/Images/overview.png)
...
![Overview with wires](../MEDIA-FILES/GUIDE-IMAGES/Images/overview-wires.png)
...
|----|----|----|
| ![button top view](../MEDIA-FILES/GUIDE-IMAGES/Images/button-top.png)| ![button bottom view](../MEDIA-FILES/GUIDE-IMAGES/Images/button-bottom.png)| ![button soldering](../MEDIA-FILES/GUIDE-IMAGES/Images/button-soldering.png) |
...
|----|----|
|  ![connecting to TinyPico](../MEDIA-FILES/GUIDE-IMAGES/Images/connecting-tinypico.png)|  ![Completed button circuit](../MEDIA-FILES/GUIDE-IMAGES/Images/button-completecircuit.png) |
...
|----|----|----|
| ![soldering two wires](../MEDIA-FILES/GUIDE-IMAGES/Images/fsr-twowire.png) |  ![heat shrinking](../MEDIA-FILES/GUIDE-IMAGES/Images/heatshrink-fsrtwowire.png) |  ![onnecting to tinypico FSR](../MEDIA-FILES/GUIDE-IMAGES/Images/fsr-tinypico.png)|
...
|----|----|
|     ![oldering wire to FSR](../MEDIA-FILES/GUIDE-IMAGES/Images/fsr-soldering.png)|  ![heat shrinking on fsr](../MEDIA-FILES/GUIDE-IMAGES/Images/fsr-heatshrink.png)|
...
|----|----|
|  ![twisting 3v3 wire](../MEDIA-FILES/GUIDE-IMAGES/Images/wire-twisted.png)|  ![view of 3v3 wire](../MEDIA-FILES/GUIDE-IMAGES/Images/wire-twisted-view2.png)|
...
|----|----|----|
|   ![imu wiring](../MEDIA-FILES/GUIDE-IMAGES/Images/imu-wiring.png)|   ![imu wiring to tinypico](../MEDIA-FILES/GUIDE-IMAGES/Images/imu-tinypico.png) |  ![imu wiring alternative wiring](../MEDIA-FILES/GUIDE-IMAGES/Images/imu-wiring-topview.png) |
...
|----|----|
|   ![trill connections](../MEDIA-FILES/GUIDE-IMAGES/Images/trill-wiring.png) |   ![rill connections alternate view](../MEDIA-FILES/GUIDE-IMAGES/Images/trill-wiring2.png)|
...
|----|----|
|   ![opper soldering](../MEDIA-FILES/GUIDE-IMAGES/Images/copper-soldering.png) |   ![alternate view](../MEDIA-FILES/GUIDE-IMAGES/Images/copper-soldering2.png) |
...
![T-Stick Sopranino orientation](../MEDIA-FILES/GUIDE-IMAGES/Images/orientation.png)
![T-Stick inserted in pipe](../MEDIA-FILES/GUIDE-IMAGES/Images/tstick-insert.png)
...
|----|----|
|  ![on/off circuit wiring](../MEDIA-FILES/GUIDE-IMAGES/Images/power-circuit.png) | ![power circuit alternate view](../MEDIA-FILES/GUIDE-IMAGES/Images/powercircuit-overview.png) |
