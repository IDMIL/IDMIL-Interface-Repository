...
**WARNING**: This guide is written for the preview firmware for the T-Stick 5GW located at https://github.com/aburt2/T-Stick/tree/5gw-main.
...
4. In Visual Studio, under the File menu select open folder.
  ![open folder button in VS code code](../MEDIA-FILES/BUILD-GUIDE-IMAGES/Images/vscode-open-folder.png)
...
13. Select `Build Filesystem Image`.
  ...
  ![PlatformIO project Tasks](../MEDIA-FILES/BUILD-GUIDE-IMAGES/Images/vscode-project-tasks.png)
### Upload the Firmware and Filesystem Image

**NOTE**: If your T-Stick was in deep sleep prior to flashing, you may have to wake up the instrument by pressing the button for it to show up on your computer.
